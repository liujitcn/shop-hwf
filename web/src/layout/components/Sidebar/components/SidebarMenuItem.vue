    ...
    >
      <AppLink
        ...
        :to="{
          ...
          query: resolveParams(onlyOneChild.meta.params),
        }"
      >
        <el-menu-item
...
import { BaseMenuParams } from "@/rpc/admin/base_menu";
 ...
 * @returns 获取参数
 */
function resolveParams(params: BaseMenuParams[]) {
  let res = reactive<Record<string, string>>({});
  params?.map((item) => {
