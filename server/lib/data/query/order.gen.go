...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.PayMoney = field.NewInt64(tableName, "pay_money")
	_order.TotalMoney = field.NewInt64(tableName, "total_money")
	_order.PostFee = field.NewInt64(tableName, "post_fee")
	_order.GoodsNum = field.NewInt64(tableName, "goods_num")
	_order.PayType = field.NewInt32(tableName, "pay_type")
	_order.PayChannel = field.NewInt32(tableName, "pay_channel")
