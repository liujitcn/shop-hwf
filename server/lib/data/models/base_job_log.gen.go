...
type BaseJobLog struct {
	...
	ProcessTime int32     `gorm:"column:process_time;type:int;comment:消耗时间/毫秒" json:"process_time"`                              // 消耗时间/毫秒
	ExecuteTime time.Time `gorm:"column:execute_time;type:datetime;comment:执行时间" json:"execute_time"`                            // 执行时间
}
