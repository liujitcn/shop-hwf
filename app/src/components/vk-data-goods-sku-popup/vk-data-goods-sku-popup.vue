  ...
  >
    ...
    >
        ...
        <scroll-view class="specification-wrapper-content" scroll-y="true">
          <view class="specification-header">
            <view class="specification-left">
              <image
                class="product-img"
                :src="formatSrc(selectShop.image ? selectShop.image : goodsInfo[goodsThumbName])"
              ...
              <view class="item-wrapper">
                <view
                  ...
                  :style="[
                    ...
                    subIndex[index1] === index2 ? themeColorFn('activeStyle') : '',
                  ]"
      ...
      <view class="btn-wrapper" v-else-if="mode === 1">
        <view
          class="sure add-cart"
          style="border-radius: 38rpx 0 0 38rpx"
          :style="{
        ...
        <view
          class="sure"
          style="border-radius: 0 38rpx 38rpx 0"
          :style="{
...
export default {
  ...
  methods: {
    ...
    checkInpath(clickIndex) {
      ...
      for (let i = 0, len = specList.length; i < len; i++) {
        ...
        for (let j = 0; j < len2; j++) {
          ...
          let choose_copy = [...that.selectArr]
          that.$set(choose_copy, i, specList[i].list[j].name)
          let choose_copy2 = choose_copy.filter(
            (item) => item !== '' && typeof item !== 'undefined',
          )
          if (that.shopItemInfo.hasOwnProperty(that.getArrayToSting(choose_copy2))) {
    ...
    previewImage() {
      ...
      let src = formatSrc(selectShop.image ? selectShop.image : goodsInfo[goodsThumbName])
      if (src) {
        uni.previewImage({
          urls: [src],
        })
